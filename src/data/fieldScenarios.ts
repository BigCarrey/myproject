    ...
    steps: [
      {
        aiMessages: [
          ...
          {
            type: 'text',
            content: '王老师，以下为您的客户全景大图。结合当下司庆季营销节点，为您推荐20位重点客户，其中银行存款到期客户5位，旺财余额大于5万的客户3位，资产规模大于600W的客户10位。根据这些客户近半年和您的互动情况分析，中高温客户有8位，根据经验数据看同类型的客户转化率接近10%，提醒您尽快邀约拜访直接进行产品推荐！另外12位低温客户，长久未联系，建议您根据平台提供的素材与客户通过微信增进互动。\n\n您可以对我推荐您的盘客名单进行调整，也可以告诉我您想添加的本月经营客户，我帮您查找并加进去',
  ...
  // ==================== 功能⑫ 访/邀+转：陈诚专属保险方案 ====================
  {
    ...
    steps: [
      ...
      // Step 3: AI 模拟客户提出异议
      {
        ...
        quickReplies: [
          { label: '我也很理解您的想法，在我没有接触保险之前我也是这样认为。保险其实就是花小钱办大事，用每年20万的投入，换取最高500万的风险保障，关键时刻能救急。您看，您现在每年在旅游、餐饮上的花费加起来可能也不少，但保险是真正能保障家人未来的投入，建议您再考虑下。', value: 'roleplay-response' },
        ],
      },
      // Step 4: 演练完成
      {
