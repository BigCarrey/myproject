    ...
    steps: [
        ...
        aiMessages: [
          {
            ...
            speechText: '嘿，小李！我是你的AI营销分身，先了解一下你。你平时有什么爱好？',
          },
        ],
        quickReplies: [
          { label: '我对医疗健康很感兴趣，平时也在关注康养领域', value: 'hobbies-healthcare' },
        ],
      },
      ...
      // Step 1: 真实回应爱好，有洞察，问社交圈
      {
        aiMessages: [
          {
            type: 'text',
            content: '医疗健康、康养 🏥\n\n这个方向很有前景——老龄化加速，越来越多人开始关注医养结合，有这个背景的人做保险天然有说服力。\n\n而且「医养达人」这个人设，在朋友圈里特别有差异化——你不只是在卖保险，你是一个懂健康管理、有专业视角的人，顺便帮朋友做了靠谱的保障规划。这个感觉，客户能体会到的。\n\n那**你平时的圈子呢**？身边大多是什么类型的人？',
            speechText: '医养达人，这个人设在朋友圈很有差异化！你平时的圈子呢？',
            wechatEvents: [
              {
                type: 'update-memory',
                data: [
                  {
                    ...
                    value: '医疗健康、康养',
                    category: 'dynamic',
                    narrative: '关注医疗健康和康养领域，专业感强。「医养达人」是天然的朋友圈IP——有内容深度，不像在硬卖保险，客户感觉得出来。',
                  },
                ],
              },
            ],
        ...
        quickReplies: [
          { label: '康养行业朋友为主，也认识一些做生意的老板朋友', value: 'social-circle' },
        ],
      },
      ...
      // Step 2: 回应社交圈，问目标
      {
        aiMessages: [
          {
            type: 'text',
            content: '做生意的朋友 + 康养圈 🎯\n\n这个组合很有价值——做生意的朋友有保障意识、有实力，但信任门槛高，不能急；康养圈的人对健康管理和医养规划天然敏感，对保险的接受度高，转化路径更顺。\n\n**最后一个：今年最想突破的是什么？** 业绩目标？还是某类客户？',
            speechText: '康养圈接受度高，老板朋友是高净值潜力，这组合很有价值。今年最想突破什么？',
            wechatEvents: [
              {
                type: 'update-memory',
                data: [
                  {
                    ...
                    value: '康养圈 + 老板朋友',
                    category: 'dynamic',
                    narrative: '社交圈以康养行业朋友为主，也认识一些做生意的老板朋友。前者对健康保障天然敏感、转化顺；后者有实力有意识，是高净值客户的潜在来源。',
                  },
                ],
              },
            ],
      ...
      // Step 3: 收到目标，鼓励+自然过渡到朋友圈
      {
        aiMessages: [
          {
            ...
            speechText: '好，记住了！你圈子里从不缺好客户，让他们看见你——交给我。',
            wechatEvents: [
              {
                type: 'update-memory',
                data: [
                  {
                    ...
                    value: '年度业绩翻倍',
                    category: 'dynamic',
                    narrative: '今年目标是业绩翻倍，核心突破口是高净值客户。医养达人人设加上精准圈子，让客户先看见你、信任你，是打开局面的关键。',
                  },
                ],
              },
            ],
        ...
        quickReplies: [
          { label: '✨ 启动我的AI营销助理', value: 'start-work', primary: true },
        ],
      },
            ...
            wechatEvents: [
              { type: 'switch-execution-tab', data: 'moments' },
              {
                ...
                data: {
                  author: '小李',
                  avatar: '🏥',
                  content: '周末参观了本地的高端康养社区，看到完善的医疗配套和专业的照护，心里格外踏实～ 就像做保险这两年，每一次为客户规划保障方案，都和配置医养资源一样：前期充分准备，过程稳步推进，最终才能让客户收获安心。最近看到 #国内老龄化趋势及高端养老社区一床难求# 的新闻，更觉得"保障"不分场景 —— 身体需要日常的养护和专业医疗支持，生活需要保险和养老规划兜底。如果你也关注健康养生，或想给家人提前锁定优质医养资源及全面保障，随时找我聊聊呀～',
                  images: ['康养社区环境图', '养老趋势新闻截图'],
                  imageUrls: [
