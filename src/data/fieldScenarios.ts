    ...
    steps: [
      {
        aiMessages: [
          {
            type: 'text',
            content: '👋 王老师，结合当下司庆季营销节点，为您推荐 **20位** 重点客户，其中银行存款到期客户5位，旺财余额大于5万的客户3位，资产规模大于600万的客户10位。根据这些客户近半年和您的互动情况分析，**中高温客户有8位**，根据经验数据看同类型客户转化率接近10%，提醒您尽快邀约拜访直接进行产品推荐！**冷却客户有5位**，长期未联系易导致关系疏远，提醒您加强线上互动频次，提升客户关系。\n\n是否为您添加至**4月经营计划**中？',
            speechText: '王芳老师，司庆季开始了！为您推荐20位重点客户，其中中高温客户8位，转化率接近10%，建议尽快邀约拜访。另有冷却客户5位，长期未联系易导致关系疏远，提醒加强线上互动频次。是否添加至4月经营计划？',
          },
          {
            type: 'field-customer-temperature',
            content: '',
            data: {
              total: 20,
              hotCount: 8,
