...
export const scenarios: Scenario[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: '个性内容定制',
    icon: '✨',
    description: '结合人设、热点、城市，AI定制个性化朋友圈',
    steps: [
      {
        aiMessages: [
          {
            type: 'text',
            content: '小李，早上好！我已获取您的**运动人设**、今日**体育热点新闻**以及**深圳本地**信息，为您量身定制了一条朋友圈内容。请预览并确认发布👇',
            speechText: '小李早上好，AI已融合您的运动人设、体育热点和深圳本地信息，为您生成了一条个性化朋友圈，请预览确认。',
          },
          {
            type: 'v3-moments-post',
            content: '',
            data: {
              persona: ['运动人设', '近期体育新闻', '深圳本地', '保险场景'],
        ...
        quickReplies: [
          { label: '✅ 确认发布', value: 'v3-confirm-publish', icon: '✅' },
          { label: '修改内容', value: 'v3-edit-content' },
        ],
      },
      {
        aiMessages: [
          {
            ...
            speechText: '朋友圈发布成功，时间十点三十二分，预计触达潜在客户43位。',
          },
          {
            type: 'text',
            content: '✅ **朋友圈发布成功，10:32**\n\n内容已同步覆盖您的 **287 位好友**，预计触达潜在保险需求客户约 **43 位**。\n\n📌 AI 正在监控好友互动，若有人点赞或私信，将第一时间提醒您。',
            speechText: '朋友圈发布成功，预计触达43位潜在客户，AI正在监控好友互动。',
            delay: 500,
          },
        ],
        quickReplies: [
          { label: '等待客户反应', value: 'v3-wait' },
          { label: '⏩ 跳到：收到私信', value: 'v3-smart-reply' },
        ],
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: '截图智能回复',
    icon: '📸',
    description: '输入法AI截图帮回，智能识别咨询意图',
    steps: [
      {
        aiMessages: [
          {
            type: 'text',
            content: '📱 **收到微信私信提醒！**\n\n约20分钟后，好友王哥发来私信，AI检测到潜在咨询意图，小李立即调用**输入法AI截图帮回**功能👇',
            speechText: '收到微信私信提醒，约20分钟后好友王哥发来私信，小李立即调用输入法AI截图帮回功能。',
          },
          {
            type: 'v3-screenshot-reply',
            content: '',
            data: {
              customerName: '王哥',
              incomingMessage: '嗨小李，看你跑步这么拼！我最近体检查出三高，我这种情况还能买保险吗？',
              analysis: '识别到提问属于**健康告知咨询**，情绪带有轻微焦虑。',
              analysisPoints: [
                '当前处于意向初步萌发期',
                '建议：先安抚情绪，再引导预约',
                '不宜直接推产品，需建立信任感',
              ],
              suggestedReply: '王哥！三高不是拒之门外的门槛，关键看指标控制情况😊 很多客户和你情况类似，最后都顺利配置了适合自己的方案。你方便的话咱们约个时间当面细聊聊？我帮你做个专属评估，给你一个明确的答复，不让你白等～',
            },
            delay: 500,
          },
        ],
        quickReplies: [
          { label: '一键发送推荐回复', value: 'v3-send-reply' },
          { label: '查看更多话术', value: 'v3-more-scripts' },
        ],
      },
      {
        aiMessages: [
          {
            type: 'text',
            content: '✅ 已发送！\n\n王哥很快回复：\n**"行，但我最近不在深圳，你先发我个方案看看吧"**\n\n💡 AI 提示：王哥表现出进一步了解意愿，建议先做**好友画像洞察**，再生成个性化方案，避免盲目发送。',
            speechText: '已发送，王哥回复说最近不在深圳，让先发方案看看。AI建议先做好友画像洞察，再生成个性化方案。',
          },
        ],
        quickReplies: [
          { label: '🔍 扫描王哥朋友圈', value: 'v3-friend-insights' },
        ],
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: '好友兴趣洞察',
    icon: '👁️',
    description: 'AI扫描朋友圈，生成客户画像',
    steps: [
      {
        aiMessages: [
          {
            type: 'text',
            content: '🔍 **正在扫描王哥的朋友圈公开动态...**\n\n分析维度：发帖频率 · 转发内容 · 兴趣标签 · 消费偏好 · 家庭线索',
            speechText: '正在扫描王哥朋友圈公开动态，分析兴趣、消费偏好等多个维度。',
          },
          {
            type: 'v3-customer-profile',
            content: '',
            data: {
              name: '王哥',
              avatar: '王',
              ageRange: '42-48岁',
              role: '企业中高层管理者',
              tags: ['高净值', '品质消费', '价格不敏感', '家庭责任重'],
              interests: ['高尔夫', '养生健康', '商业资讯', '亲子教育'],
              insights: [
                { label: '孩子年龄', value: '约10岁，小学阶段', icon: '👦' },
                { label: '近期关注', value: '多次转发健康管理文章', icon: '📰' },
                { label: '消费风格', value: '注重品质，对价格不敏感', icon: '💎' },
                { label: '活跃时段', value: '工作日晚间，周末全天', icon: '⏰' },
              ],
            },
            delay: 600,
          },
        ...
        quickReplies: [
          { label: '深入分析保险需求', value: 'v3-needs-analysis' },
        ],
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: '个性需求解析',
    icon: '🔍',
    description: 'AI解析客户核心与次要保险需求',
    steps: [
      {
        aiMessages: [
          {
            type: 'text',
            content: '基于朋友圈洞察 + 三高状态 + 家庭结构，AI 输出**王哥专属需求解析报告**👇',
            speechText: '基于朋友圈洞察和健康状态，AI输出王哥专属需求解析报告。',
          },
          {
            type: 'v3-customer-profile',
            content: '',
              ...
              needs: [
                {
                  ...
                  level: 'primary',
                  urgency: 5,
                  desc: '三高状态下重疾和寿险需求最为紧迫，是家庭收入的核心支柱，一旦出险家庭将面临巨大财务压力。',
                },
                {
                  label: '子女教育规划',
                  level: 'secondary',
                  urgency: 3,
                  desc: '孩子约10岁，距离大学教育约8年，是启动教育金储备的合适节点。',
                },
                {
                  label: '财富传承',
                  level: 'secondary',
                  urgency: 2,
                  desc: '企业中高层，有资产规划和传承意识，可作为后续深度服务切入点。',
                },
              ],
              urgencyNote: '三高状态下核保窗口随时可能收紧，当前是配置重疾险和寿险的最佳时机，紧迫程度 ⭐⭐⭐⭐',
            },
            delay: 400,
          },
        ],
        quickReplies: [
          { label: '生成询问话术', value: 'v3-script-recommend' },
        ],
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: '精准话术推荐',
    icon: '💬',
    description: 'AI生成自然切入的询问话术',
    steps: [
      {
        aiMessages: [
          {
            type: 'text',
            content: '💡 **AI 提示：**\n\n要为王哥精准匹配方案，还需了解他**家庭现有保障情况**。我来帮你设计一段自然切入的询问话术，点击发送即可。',
            speechText: 'AI提示：要为王哥精准匹配方案，还需了解他家庭现有保障情况，已生成询问话术。',
          },
          {
            type: 'text',
            content: '**推荐话术：**\n\n"王哥，我这边已经根据你的情况初步做了个方向，但想给你一个真正合适的方案，还需要了解你家里目前的保障配置——比如你和家人有没有在其他地方买过重疾险或寿险？公司团险大概覆盖哪些？大概几分钟，你回复我几个关键信息就够了。"',
            speechText: '话术已生成：王哥，我这边已经根据你的情况初步做了个方向，但想给你一个真正合适的方案，还需要了解你家里目前的保障配置。',
            delay: 300,
          },
        ],
        quickReplies: [
          { label: '一键发送', value: 'v3-script-sent' },
          { label: '修改话术', value: 'v3-edit-script' },
        ],
      },
      {
        aiMessages: [
          {
            ...
            speechText: '已发送，王哥回复：公司团险有意外险和医疗险，重疾险20万保额，其他没有。AI正在分析保障缺口。',
          },
        ],
        quickReplies: [
          { label: '查看保障缺口诊断', value: 'v3-gap-diagnosis' },
        ],
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: '保障缺口诊断',
    icon: '🏥',
    description: 'AI结合现有保障诊断缺口与风险',
    steps: [
      {
        aiMessages: [
          {
            type: 'text',
            content: '🏥 **AI 保障缺口诊断报告**\n\n结合王哥的年龄（42-48岁）、三高状况、家庭结构及现有保障信息，输出诊断结果：\n\n**① 意外险 + 医疗险**\n✅ 公司团险已覆盖\n⚠️ 风险提示：**团险与工作绑定，一旦离职或公司变动，两项保障同步清零，不可单独续保。**\n\n**② 重疾险**\n❌ 严重缺口 —— 现有20万保额远不够\n以王哥收入水平和家庭负担，**至少需要100万以上**才能覆盖治疗期间医疗费用与收入损失，缺口约 **80万**。\n\n**③ 寿险**\n❌ 几乎空白 —— 孩子尚小，家庭责任重\n一旦出险，家庭将面临**巨大财务压力**，需立即补充。\n\n**④ 养老规划**\n❌ 完全未启动 —— 45岁前是黄金配置期',
            speechText: 'AI保障缺口诊断完成：意外和医疗险依赖公司团险，风险极高；重疾险严重缺口约80万；寿险几乎空白；养老规划完全未启动。',
          },
          {
            type: 'text',
        ...
        quickReplies: [
          { label: '查看精准方案推荐', value: 'v3-product-match' },
        ],
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: '产品精准匹配',
    icon: '📦',
    description: 'AI根据画像和缺口自动输出两套方案',
    steps: [
      {
        aiMessages: [
          {
            type: 'text',
            content: '根据王哥的**客户画像**、**保障缺口**和**三高核保条件**，AI 自动输出两套方案👇',
            speechText: '根据王哥的画像和缺口分析，AI自动输出两套方案。',
          },
          {
            type: 'v3-product-match',
            content: '',
            data: {
              plans: [
                {
                  ...
                  tag: '三险联动',
                  tagColor: '#4F6BF6',
                  products: ['重疾险（100万）', '医疗险（百万）', '寿险（200万）'],
                  yearlyPremium: '3.2万元',
                  features: [
                    '重疾保额100万，覆盖治疗+收入损失全周期',
                    '百万医疗险补充团险，离职后独立续保',
                    '寿险200万，确保家庭财务不断层',
                    '三高可核保，附加健康告知说明',
                  ],
                  recommended: true,
                  aiNote: '核保友好，三高客户成功率高，建议优先呈现',
                },
                {
                  name: '尊享版',
                  tag: '保障+传承',
                  tagColor: '#F59E0B',
                  products: ['重疾险（100万）', '医疗险（百万）', '寿险（200万）', '年金险'],
                  yearlyPremium: '5.8万元',
                  features: [
                    '在均衡版基础上增加年金险',
                    '保障与财富传承双轮驱动',
                  ...
                  aiNote: '佣金约为均衡版的1.7倍，长期续期收益更稳定',
                },
              ],
              aiRecommendNote: '建议优先呈现均衡版。王哥决策型人格，给两个选项比给一个更容易成交。尊享版作为升级选项，由客户自行选择。',
            },
            delay: 500,
          },
        ],
        quickReplies: [
          { label: '帮我算佣金', value: 'v3-income-calc' },
          { label: '直接生成素材', value: 'v3-materials-gen' },
        ],
      },
    ],
  },
              ...
              plans: [
                {
                  ...
                  yearlyPremium: '3.2万元',
                  firstYearRate: '约35%',
                  firstYearIncome: '约1.12万元',
                  renewalIncome: '续期3年合计约1.8万元',
                  highlight: false,
                },
                {
                  planName: '尊享版',
                  yearlyPremium: '5.8万元',
                  firstYearRate: '约35%',
                  firstYearIncome: '约2万元',
                  renewalIncome: '续期3年合计约3.1万元',
                  highlight: true,
                },
              ],
              aiNote: '尊享版佣金约为均衡版的1.7倍，且年金险属于长期续期产品，后续收益更稳定。建议将尊享版作为"升级选项"自然呈现给王哥。',
            },
            delay: 400,
          },
        ],
        quickReplies: [
          { label: '生成讲解素材', value: 'v3-materials-gen' },
        ],
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    name: '讲解素材生成',
    icon: '📄',
    description: 'AI自动生成4份素材，一键发送给客户',
    steps: [
      {
        aiMessages: [
          {
            type: 'text',
            content: '📄 **AI 正在自动生成讲解素材包...**\n\n共 4 份材料，全部针对王哥情况定制，点击「一键全部发送」即可直接发给王哥。',
            speechText: 'AI正在自动生成4份讲解素材，针对王哥情况定制，可一键全部发送。',
          },
          {
            type: 'v3-materials',
            content: '',
            data: {
              materials: [
                {
                  title: '一页纸方案总览',
                  desc: '配图简洁无术语，适合王哥发给家人共同决策',
                  icon: '📋',
                  type: 'PDF',
                },
                {
                  title: '三高客户核保说明',
                  desc: '逐条说明哪些情况可承保、需补充哪些体检材料',
                  icon: '🏥',
                  type: '说明文档',
                },
                {
                  title: '理赔流程动图',
                  desc: '30秒看懂从报案到到账全流程，消除理赔疑虑',
                  icon: '🎬',
                  type: 'GIF动图',
                },
                {
                  title: '同类客户脱敏案例',
                  desc: '"一位45岁企业主，同样三高，去年确诊心梗，当月理赔到账68万。"',
                  icon: '📖',
                  type: '真实案例',
                },
              ],
              customerReply: '你这个做得很细，我发给我老婆看看，这周给你答复。',
              followUpNote: '已为你设置3天后回访提醒（3月9日 10:00），届时AI将自动推送跟进话术。',
            },
            delay: 500,
          },
        ],
        quickReplies: [
          { label: '✅ 完成，等待王哥答复', value: 'v3-done' },
          { label: '从头回顾全流程', value: 'v3-moments-create' },
        ],
      },
      {
        aiMessages: [
          {
            type: 'text',
            content: '🎉 **本次经营已全部完成！**\n\n**本次 AI 助力小结：**\n• ✨ 朋友圈引流 → 精准触达 43 位潜在客户\n• 📸 截图帮回 → 3秒识别意图，安抚焦虑情绪\n• 👁️ 画像洞察 → 5维度客户分析\n• 🏥 缺口诊断 → 精准定位 80万重疾缺口\n• 📦 方案匹配 → 双方案提升成交概率\n• 💰 收益测算 → 尊享版佣金 ×1.7\n• 📄 素材一键发送 → 辅助客户家庭决策\n\n🔔 **AI 已设置3天后回访提醒**，届时将自动推送最佳跟进话术。',
            speechText: '本次经营全部完成，AI已完成朋友圈引流、意图识别、画像洞察、缺口诊断、方案匹配和素材生成全流程。AI已设置三天后回访提醒。',
          },
        ],
        quickReplies: [
          { label: '重新演示', value: 'v3-moments-create' },
        ],
      },
    ],
  },
